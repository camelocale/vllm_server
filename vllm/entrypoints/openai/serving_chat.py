...
import fasttext
lang_detect_model = fasttext.load_model('/home/user/code/vllm/vllm/entrypoints/openai/lid.176.ftz')
...
def detect_lang(text):
    detected_lang = lang_detect_model.predict(text.replace("\n", ""))[0][0]
            ...
            async for res in result_generator:
                ...
                for output in res.outputs:
                    ...
                    if output.finish_reason is None:
                        ...
                        add_text = data_dict['choices'][0]['delta']['content']
                        print(add_text, end="", flush=True)
                        ...
                        # is_continue = detect_lang()
                        # print(is_continue)
                        

                        # if not is_continue:
                        #     raise ValueError("The output is not Korean.")
